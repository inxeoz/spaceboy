...
[params]
  ...
  # Feature toggles
  enableCopyCode = true
  enableRemoteFonts = true   # JetBrains Mono by default (set false to use only system/local fonts)
  enableCDNFallback = true   # Fall back to CDN if local vendor assets fail
  legacyMode = false         # Disable advanced JS features for old/limited browsers

  # Local-first asset URLs (CDN used only as fallback when enabled)
  fancyboxCSSLocal = "/vendor/fancybox/fancybox.css"
  fancyboxJSLocal  = "/vendor/fancybox/fancybox.umd.js"
  mermaidJSLocal   = "/vendor/mermaid/mermaid.min.js"

  # Optional CDN fallback URLs
  ...
  mermaidJSCDN   = "https://cdn.jsdelivr.net/npm/mermaid@11.14.0/dist/mermaid.min.js"
...
---
title: "My First Post"
show-title: true # default true; set false to hide title in post content
date: 2024-01-01
draft: false
author: "Your Name"
tags: ["hugo", "blog"]
...
use center tag to center the element

```markdown

{{< center >}}
![i4z-icon](https://cdn.jsdelivr.net/gh/inxeoz/i4z/icons/0466c8.svg)
{{< /center >}}
